      ...
      return (
        <form className="container" style={{marginBottom: "10px"}} onSubmit={props.submitSearch}>
          <div className="row">
            ...
            <div className="form-group col-md-6">
              <input className="form-control" name="location" onChange={props.handleSearch} type="search" placeholder="Search by location (eg. Toronto)" autoComplete="off" aria-label="Location" />
            </div>
          </div>
